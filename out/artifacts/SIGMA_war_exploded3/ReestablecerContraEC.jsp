...
<div class="login-box">
    ...
    <form method="post" action="RegistroServlet">
        <div class="user-box">
            <input type="text" name="nuevacontrasenia">
            <label>Escriba su contraseña</label>
        </div>
        <div class="user-box">
            <input type="text" name="nuevacontraseniaconfirmacion">
            <label>Escriba su contraseña nuevamente</label>
        </div>
        <div class="user-box">
        ...
        <input type="hidden" value="Cambiar Contrasenia" name="Registrar">
    </form>
</div>
